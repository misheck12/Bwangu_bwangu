...
<div class="business">
        ...
        <div class="col-md-8">
            <div class="input-group">
                <input
                    ...
                    name="title_color"
                    value="{{ isset($data['title_color']) ? $data['title_color'] : '#222' }}"
                >
            </div>
        </div>
    </div>
    ...
    <!--begin::row section_sub_title_color -->
    <div class="row mb-6 section_sub_title_color">
        <label class="col-md-4 fw-bold fs-6"> @lang('theme_goshippo::view.section_sub_title_color') </label>
        <div class="col-md-8">
            <div class="input-group">
                <input
                    class="form-control form-control-color w-100 color_picker_input_{{isset($id) ? $id : 'id'}} section_sub_title_color_input"
                    name="section_sub_title_color"
                    value="{{ isset($data['section_sub_title_color']) ? $data['section_sub_title_color'] : '#222' }}"
                >
            </div>
        </div>
    </div>
    <!--end::row section_sub_title_color -->
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
                ...
                <div class="input-group lang_container" id="lang_container_section_sub_title">
                    ...
                    <input
                        type="text"
                        name="section_sub_title[{{app()->getLocale()}}]"
                        title="{{app()->getLocale()}}"
                        class="form-control section-title form-control-multilingual form-control-{{app()->getLocale()}}"
                        value="{{ isset($data['section_sub_title']) && isset($data['section_sub_title'][app()->getLocale()]) ? $data['section_sub_title'][app()->getLocale()] : '' }}"
                    >
                    @foreach(get_langauges_except_current() as $locale)
                        <input
                            type="text"
                            name="section_sub_title[{{ $locale['code'] }}]"
                            title="{{ $locale['code'] }}"
                            class="form-control section-title form-control-multilingual form-control-{{$locale['code']}}  d-none"
                            value="{{ isset($data['section_sub_title']) && isset($data['section_sub_title'][$locale['code']]) ? $data['section_sub_title'][$locale['code']] : '' }}"
                        >
                    @endforeach
                </div>
    ...
    <!--begin::row card_5_bg_color -->
    <div class="row mb-6 card_5_bg_color">
        <label class="col-md-4 fw-bold fs-6"> @lang('theme_goshippo::view.card_5_bg_color') </label>
        <div class="col-md-8">
            <div class="input-group">
                <input
                    class="form-control form-control-color w-100 color_picker_input_{{isset($id) ? $id : 'id'}} card_bg_color_input"
                    name="card_5_bg_color"
                    value="{{ isset($data['card_5_bg_color']) ? $data['card_5_bg_color'] : '#222' }}"
                >
            </div>
        </div>
    </div>
    <!--end::row card_5_bg_color -->

    <!--begin::row card_title_5_color -->
    <div class="row mb-6 card_title_5_color">
        <label class="col-md-4 fw-bold fs-6"> @lang('theme_goshippo::view.card_title_5_color') </label>
        <div class="col-md-8">
            <div class="input-group">
                <input
                    class="form-control form-control-color w-100 color_picker_input_{{isset($id) ? $id : 'id'}} card_title_5_color_input"
                    name="card_title_5_color"
                    value="{{ isset($data['card_title_5_color']) ? $data['card_title_5_color'] : '#222' }}"
                >
            </div>
        </div>
    </div>
    <!--end::row card_title_5_color -->

    <!--begin::row card_desc_5_color -->
    <div class="row mb-6 card_desc_5_color">
        <label class="col-md-4 fw-bold fs-6"> @lang('theme_goshippo::view.card_desc_5_color') </label>
        <div class="col-md-8">
            <div class="input-group">
                <input
                    class="form-control form-control-color w-100 color_picker_input_{{isset($id) ? $id : 'id'}} card_desc_5_color_input"
                    name="card_desc_5_color"
                    value="{{ isset($data['card_desc_5_color']) ? $data['card_desc_5_color'] : '#222' }}"
                >
            </div>
        </div>
    </div>
    <!--end::row card_desc_5_color -->
        ...
        <div class="col-md-8">
                ...
                <div class="input-group lang_container" id="lang_container_card_title_5">
                    ...
                    <input
                        ...
                        title="{{app()->getLocale()}}"
                        class="form-control section-title form-control-multilingual form-control-{{app()->getLocale()}}"
                        value="{{ isset($data['card_title_5']) && isset($data['card_title_5'][app()->getLocale()]) ? $data['card_title_5'][app()->getLocale()] : '' }}"
                    >
                    @foreach(get_langauges_except_current() as $locale)
                        <input
                            type="text"
                            ...
                            title="{{ $locale['code'] }}"
                            class="form-control section-title form-control-multilingual form-control-{{$locale['code']}}  d-none"
                            value="{{ isset($data['card_title_5']) && isset($data['card_title_5'][$locale['code']]) ? $data['card_title_5'][$locale['code']] : '' }}"
                        >
                    @endforeach
                </div>
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
                ...
                <div class="input-group lang_container text" id="lang_container_card_description_5">
                    ...
                    <textarea name="card_description_5[{{app()->getLocale()}}]" title="{{app()->getLocale()}}" class="form-control form-control-lg form-control-multilingual form-control-{{app()->getLocale()}}">{{ isset($data['card_description_5']) && isset($data['card_description_5'][app()->getLocale()]) ? $data['card_description_5'][app()->getLocale()] : '' }}</textarea>
                    @foreach(get_langauges_except_current() as $locale)
                        <textarea name="card_description_5[{{ $locale['code'] }}]" title="{{ $locale['code'] }}" class="form-control section-title form-control-multilingual form-control-{{$locale['code']}}  d-none">{{ isset($data['card_description_5']) && isset($data['card_description_5'][$locale['code']]) ? $data['card_description_5'][$locale['code']] : '' }}</textarea>
                    @endforeach
                </div>
        </div>
    </div>
        ...
        <div class="col-md-8">
            <div class="input-group">
                <input
                    ...
                    value="{{ isset($data['button_bg_color']) ? $data['button_bg_color'] : '#222' }}"
                >
            </div>
        </div>
    </div>
        ...
        <div class="col-md-8">
            <div class="input-group">
                <input
                    ...
                    value="{{ isset($data['button_text_color']) ? $data['button_text_color'] : '#222' }}"
                >
            </div>
        </div>
    </div>
