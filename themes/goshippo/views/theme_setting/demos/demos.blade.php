<div class="demos-setting">
    ...
    <div class="setting-box">
        <h4 class="setting-box-label fw-bold fs-3">@lang('theme_html::view.choose_demo') </h4>
                    ...
                    <div class="form-check mx-3">
                        <label class="px-2 py-1 text-center">
                            ...
                            <div class="form-check-label bg-white border p3">
                                ...
                                @lang('theme_html::view.main_demo')
                            </div>
                        </label>
                    </div>
                    <div class="form-check mx-3">
                        <label class="px-2 py-1 text-center">
                            ...
                            <div class="form-check-label bg-white border p3">
                                ...
                                @lang('theme_html::view.easyship_demo')
                            </div>
                        </label>
                    </div>
                    <div class="form-check mx-3">
                        <label class="px-2 py-1 text-center">
                            ...
                            <div class="form-check-label bg-white border p3">
                                ...
                                @lang('theme_html::view.flextock_demo')
                            </div>
                        </label>
                    </div>
                    <div class="form-check mx-3">
                        <label class="px-2 py-1 text-center">
                            ...
                            <div class="form-check-label bg-white border p3">
                                ...
                                @lang('theme_html::view.goshippo_demo')
                            </div>
                        </label>
                    </div>
                    <div class="form-check mx-3">
                        <label class="px-2 py-1 text-center">
                            ...
                            <div class="form-check-label bg-white border p3">
                                ...
                                @lang('theme_html::view.qwintry_demo')
                            </div>
                        </label>
                    </div>
                    <div class="form-check mx-3">
                        <label class="px-2 py-1 text-center">
                            ...
                            <div class="form-check-label bg-white border p3">
                                ...
                                @lang('theme_html::view.shipito_demo')
                            </div>
                        </label>
                    </div>
                    <div class="form-check mx-3">
                        <label class="px-2 py-1 text-center">
                            ...
                            <div class="form-check-label bg-white border p3">
                                ...
                                @lang('theme_html::view.timeglobalshipping_demo')
                            </div>
                        </label>
                    </div>
                </div>
