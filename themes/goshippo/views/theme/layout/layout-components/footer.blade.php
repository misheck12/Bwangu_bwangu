...
<footer id="main-footer" style="{{ 
            (array_key_exists('footer_bg', $footer_setting) && $footer_setting['footer_bg'] ? "background: {$footer_setting['footer_bg']} !important;" : 'background: #111026;')
            .
            (array_key_exists('footer_text_color', $footer_setting) && $footer_setting['footer_text_color'] ? "color: {$footer_setting['footer_text_color']} !important;" : 'color: #FFF;')
            }}"
>
    <div class="container">
