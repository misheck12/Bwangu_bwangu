...
@php
    ...
    $section_sub_title_color   = array_key_exists('section_sub_title_color', $data) && $data['section_sub_title_color'] ? "color: {$data['section_sub_title_color']} !important;" : 'color: #222;';
    ...
    $card_5_bg_color  = array_key_exists('card_5_bg_color', $data) && $data['card_5_bg_color'] ? "background-color: {$data['card_5_bg_color']} !important;" : 'background-color: #222;';
    ...
    $card_title_5_color  = array_key_exists('card_title_5_color', $data) && $data['card_title_5_color'] ? "color: {$data['card_title_5_color']} !important;" : 'color: #222;';
    ...
    $card_desc_5_color  = array_key_exists('card_desc_5_color', $data) && $data['card_desc_5_color'] ? "color: {$data['card_desc_5_color']} !important;" : 'color: #222;';
          ...
          <div class="contents">
            <div class="row">
              <div class="col-md-6">
                <div class="row cards">
                  <div class="col-6">
                    <div class="card" style="{{$card_5_bg_color}}">
                      <div class="title" style="{{$card_title_5_color}}">{{$data['card_title_5'][app()->getLocale()] ?? ''}}</div>
                      <div class="sub" style="{{$card_desc_5_color}}">{{$data['card_description_5'][app()->getLocale()] ?? ''}}</div>
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="card" style="{{$card_4_bg_color}}">
                      <div class="title" style="{{$card_title_4_color}}">{{$data['card_title_4'][app()->getLocale()] ?? ''}}</div>
                      <div class="sub" style="{{$card_desc_4_color}}">{{$data['card_description_4'][app()->getLocale()] ?? ''}}</div>
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="card" style="{{$card_3_bg_color}}">
                      <div class="title" style="{{$card_title_3_color}}">{{$data['card_title_3'][app()->getLocale()] ?? ''}}</div>
                      <div class="sub" style="{{$card_desc_3_color}}">{{$data['card_description_3'][app()->getLocale()] ?? ''}}</div>
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="card" style="{{$card_2_bg_color}}">
                      <div class="title" style="{{$card_title_2_color}}">{{$data['card_title_2'][app()->getLocale()] ?? ''}}</div>
                      <div class="sub" style="{{$card_desc_2_color}}">{{$data['card_description_2'][app()->getLocale()] ?? ''}}</div>
                    </div>
                  </div>
                </div>
              </div>
