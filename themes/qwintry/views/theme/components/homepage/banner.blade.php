                ...
                <div class="row ">
                    <div class="col-lg-7" >
                        ...
                        <div class="d-flex flex-column align-items-center flex-md-row">
                            ...
                            <span class="text-sm text-muted">No credit card required. Cancel anytime.</span>
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="col-lg-5">
                    <div class="wrapper">
                        <img  src="{{ theme_setting_image('homepage.banner.section_banner') != '' ? theme_setting_image('homepage.banner.section_banner') : (get_general_setting('website_logo', asset('themes/qwintry/assets/images/banner.png'))) }}" alt="banner" class="banner" />
                        </div>
                    </div>
                </div>
