<div class="hero">
    ...
    <div class="row mb-6 typer_color">
        <label class="col-md-4 fw-bold fs-6"> @lang('theme_qwintry::view.section_typer_color') </label>
        <div class="col-md-8">
            <div class="input-group">
                <input
                    class="form-control form-control-color w-100 color_picker_input_{{ isset($id) ? $id : 'id' }} typer_color_input"
                    name="typer_color" value="{{ isset($data['typer_color']) ? $data['typer_color'] : '' }}">
            </div>
        </div>
    </div>
    <!--end::row typer_color -->
        ...
        <div class="col-md-8">
            ...
            <div class="input-group lang_container text" id="lang_container_section_description">
                ...
                <textarea name="section_description[{{ app()->getLocale() }}]" title="{{ app()->getLocale() }}"
                    class="form-control form-control-lg form-control-multilingual form-control-{{ app()->getLocale() }}">{{ isset($data['section_description']) && isset($data['section_description'][app()->getLocale()])? $data['section_description'][app()->getLocale()]: '' }}</textarea>
                @foreach (Config::get('langauges_except_current') as $locale)
                    <textarea name="section_description[{{ $locale['code'] }}]" title="{{ $locale['code'] }}"
                        class="form-control section-title form-control-multilingual form-control-{{ $locale['code'] }}  d-none">{{ isset($data['section_description']) && isset($data['section_description'][$locale['code']])? $data['section_description'][$locale['code']]: '' }}</textarea>
                @endforeach
            </div>
        </div>
    </div>
        ...
        <div class="col-md-8">
            ...
            <div class="input-group lang_container" id="lang_container_section_button">
                ...
                <input type="text" name="section_button1[{{ app()->getLocale() }}]"
                    title="{{ app()->getLocale() }}"
                    class="form-control section-title form-control-multilingual form-control-{{ app()->getLocale() }}"
                    value="{{ isset($data['section_button1']) && isset($data['section_button1'][app()->getLocale()])? $data['section_button1'][app()->getLocale()]: '' }}">
                @foreach (Config::get('langauges_except_current') as $locale)
                    <input type="text" name="section_button1[{{ $locale['code'] }}]" title="{{ $locale['code'] }}"
                        class="form-control section-title form-control-multilingual form-control-{{ $locale['code'] }}  d-none"
                        value="{{ isset($data['section_button1']) && isset($data['section_button1'][$locale['code']])? $data['section_button'][$locale['code']]: '' }}">
                @endforeach
            </div>
        </div>
    </div>
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-8">
            ...
            @else
                <x-media-library-attachment data-title="section_banner1" data-type="image" name="section_banner1"
                    rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp" />
            @endif
        </div>
    </div>
        ...
        <div class="col-md-8">
            @if (isset($model))
                <x-media-library-collection data-title="section_banner2" data-type="image" max-items="1"
                    ...
                    rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp" />
            @else
                <x-media-library-attachment data-title="section_banner2" data-type="image" name="section_banner2"
                    rules="mimes:jpg,jpeg,png,gif,bmp,svg,webp" />
            @endif
        </div>
    </div>
