    ...
    <div class="container">
        ...
        <div class="contents">
            <div class="wrapper">
                ...
                <img class="graphic lg" src="{{ theme_setting_image($section->id,'section_mobile_banner') != '' ? theme_setting_image($section->id,'section_mobile_banner') : (get_general_setting('website_logo', asset('themes/easyship/assets/images/good-hands-graphic-desktop.webp'))) }}" alt="good hands graphic" />
            </div>
