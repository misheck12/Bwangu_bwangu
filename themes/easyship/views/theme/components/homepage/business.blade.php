        ...
        <div class="contents">
            <div class="accordion" id="accordionExample">
                <div class="card" style="{{ array_key_exists('card_bg_color', $data) && $data['card_bg_color'] ? "background-color: {$data['card_bg_color']} !important;" :  ''  }}">
                    ...
                    >
                        <div class="body">
                            <img class="image" src="{{ theme_setting_image($section->id,'section_mobile_banner_1') != '' ? theme_setting_image($section->id,'section_mobile_banner_1') : (get_general_setting('website_logo', asset('themes/easyship/assets/images/business-crowdfunding.png'))) }}" alt="demo" />
                            <img class="image lg" src="{{ theme_setting_image($section->id,'section_banner_1') != '' ? theme_setting_image($section->id,'section_banner_1') : (get_general_setting('website_logo', asset('themes/easyship/assets/images/business-crowdfunding.png'))) }}" alt="demo" />
                ...
                <div class="card" style="{{ array_key_exists('card_bg_color', $data) && $data['card_bg_color'] ? "background-color: {$data['card_bg_color']} !important;" :  ''  }}">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                        <div class="body">
                            ...
                            <img class="image lg" src="{{ theme_setting_image($section->id,'section_banner_2') != '' ? theme_setting_image($section->id,'section_banner_2') : (get_general_setting('website_logo', asset('themes/easyship/assets/images/business-crowdfunding.png'))) }}" alt="demo" />
                ...
                <div class="card" style="{{ array_key_exists('card_bg_color', $data) && $data['card_bg_color'] ? "background-color: {$data['card_bg_color']} !important;" :  ''  }}">
                    ...
                    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                        <div class="body">
                            ...
                            <img class="image lg" src="{{ theme_setting_image($section->id,'section_banner_3') != '' ? theme_setting_image($section->id,'section_banner_3') : (get_general_setting('website_logo', asset('themes/easyship/assets/images/business-crowdfunding.png'))) }}" alt="demo" />
