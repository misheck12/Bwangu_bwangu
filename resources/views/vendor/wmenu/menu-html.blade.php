													...
													<div class="mb-4">
														...
														<div class="input-group lang_container">
															...
															<input
																...
																class="custom-menu-item-name form-control form-control-multilingual form-control-{{app()->getLocale()}}  @error('label.' . app()->getLocale()) is-invalid @enderror"
															>
															...
															@foreach(get_langauges_except_current() as $locale)
																<input
																	type="text"
																	class="custom-menu-item-name form-control  form-control-multilingual form-control-{{$locale['code']}} @error('label.' . $locale['code']) is-invalid @enderror d-none"
