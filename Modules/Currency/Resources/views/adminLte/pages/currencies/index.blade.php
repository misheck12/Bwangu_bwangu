                            ...
                            <div class="card-body border-top p-9">
                                ...
                                >
                                    @foreach ($active_currencies as $key => $currency)
                                        <option value="{{ $currency->id }}" @if(Modules\Cargo\Entities\BusinessSetting::where('type', 'system_default_currency')->first()->value == $currency->id)  selected @endif >{{ $currency->name }}</option>
                                    @endforeach
                                </select>
