...
if (\Illuminate\Support\Facades\Schema::hasTable('translations') && check_module('localization')) {
    Route::group(
        ...
        Route::middleware('auth')->prefix(env('PREFIX_ADMIN', 'admin'))->group(function() {
            ...
            Route::post('checkout/paypal/order/create', 'PaypalController@create')->name('paypal.create');
            Route::post('checkout/paypal/order/capture', 'PaypalController@capture')->name('paypal.capture');
            //Paypal START
