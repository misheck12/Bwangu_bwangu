...
if(Modules\Currency\Entities\Currency::findOrFail(get_setting('system_default_currency'))->code){
    $currency = Modules\Currency\Entities\Currency::findOrFail(get_setting('system_default_currency'))->code;
}else{
    $currency = 'USD';
}
@endphp
