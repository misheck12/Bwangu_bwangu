    ...
    <div class="col-lg-8 fv-row">
        <div class="input-group lang_container" id="lang_container_name">
            ...
            <input
                ...
                title="{{app()->getLocale()}}"
                class="form-control section-title form-control-multilingual form-control-{{app()->getLocale()}} @error('name') is-invalid @enderror"
            ...
            @foreach(get_langauges_except_current() as $locale)
                <input
                    ...
                    title="{{ $locale['code'] }}"
                    class="form-control section-title form-control-multilingual form-control-{{$locale['code']}}  d-none @error('name') is-invalid @enderror"
