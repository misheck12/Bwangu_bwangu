    ...
    public function redirectToGateway(Request $request,$shipment)
    {
        // if(Session::get('payment_type') == 'cart_payment'){
            ...
            try{
                ...
                config(['paystack.publicKey' => $paystack_payment['PAYSTACK_PUBLIC_KEY'] ]);
                config(['paystack.secretKey' => $paystack_payment['PAYSTACK_SECRET_KEY'] ]);
                config(['paystack.merchantEmail' => $paystack_payment['PAYSTACK_MERCHANT_EMAIL'] ]);
                ...
                //$request->currency = Currency::where('id',get_setting('system_default_currency'))->first()->code;
